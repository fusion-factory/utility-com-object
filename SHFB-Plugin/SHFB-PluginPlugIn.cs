...
namespace SHFB_Plugin
{
    ...
    [HelpFileBuilderPlugInExport("SHFB_Plugin", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "SHFB_Plugin plug-in")]
    public sealed class SHFB_PluginPlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In SHFB_PluginPlugIn Execute() method");
        }
        #endregion
